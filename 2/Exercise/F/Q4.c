...
int main()
{
	...
	if(hardness>50 && carbon_content <0.7 && tensile_st > 5600)
		grade = 10;
	else if(hardness>50 && carbon_content <0.7 )
		grade =9;
	else if(carbon_content<0.7 && tensile_st>5600)
		grade =8;
		...
		grade =5
	printf("the grade assigned is %d",grade);
}
